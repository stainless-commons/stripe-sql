ALTER TYPE stripe_accounts.account
  ...
  ADD ATTRIBUTE company stripe_accounts.account_company,
  ADD ATTRIBUTE controller stripe_accounts.account_controller,
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account(
  ...
  company stripe_accounts.account_company DEFAULT NULL,
  controller stripe_accounts.account_controller DEFAULT NULL,
...
ALTER TYPE stripe_accounts.account_business_profile
  ADD ATTRIBUTE annual_revenue stripe_accounts.account_business_profile_annual_revenue,
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_business_profile(
  annual_revenue stripe_accounts.account_business_profile_annual_revenue DEFAULT NULL,
...
RETURNS stripe_accounts.account_business_profile
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    support_url,
    url
  )::stripe_accounts.account_business_profile;
$$;

ALTER TYPE stripe_accounts.account_business_profile_annual_revenue
  ADD ATTRIBUTE amount BIGINT,
  ADD ATTRIBUTE currency TEXT,
  ADD ATTRIBUTE fiscal_year_end TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_business_profile_annual_revenue(
  amount BIGINT DEFAULT NULL,
  currency TEXT DEFAULT NULL,
  fiscal_year_end TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_business_profile_annual_revenue
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    amount, currency, fiscal_year_end
  )::stripe_accounts.account_business_profile_annual_revenue;
$$;

ALTER TYPE stripe_accounts.account_business_profile_monthly_estimated_revenue
  ADD ATTRIBUTE amount BIGINT, ADD ATTRIBUTE currency TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_business_profile_monthly_estimated_revenue(
  amount BIGINT, currency TEXT
)
RETURNS stripe_accounts.account_business_profile_monthly_estimated_revenue
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    amount, currency
  )::stripe_accounts.account_business_profile_monthly_estimated_revenue;
$$;

ALTER TYPE stripe_accounts.account_capability
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_capability(
...
RETURNS stripe_accounts.account_capability
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    zip_payments
  )::stripe_accounts.account_capability;
$$;

ALTER TYPE stripe_accounts.account_company
  ADD ATTRIBUTE address stripe.address,
  ADD ATTRIBUTE address_kana stripe_accounts.legal_entity_japan_address,
  ADD ATTRIBUTE address_kanji stripe_accounts.legal_entity_japan_address,
  ADD ATTRIBUTE directors_provided BOOLEAN,
  ADD ATTRIBUTE directorship_declaration stripe_accounts.account_company_directorship_declaration,
  ...
  ADD ATTRIBUTE ownership_declaration stripe_accounts.account_company_ownership_declaration,
  ...
  ADD ATTRIBUTE verification stripe_accounts.account_company_verification;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_company(
  address stripe.address DEFAULT NULL,
  address_kana stripe_accounts.legal_entity_japan_address DEFAULT NULL,
  address_kanji stripe_accounts.legal_entity_japan_address DEFAULT NULL,
  directors_provided BOOLEAN DEFAULT NULL,
  directorship_declaration stripe_accounts.account_company_directorship_declaration DEFAULT NULL,
  ...
  ownership_declaration stripe_accounts.account_company_ownership_declaration DEFAULT NULL,
  ...
  verification stripe_accounts.account_company_verification DEFAULT NULL
)
RETURNS stripe_accounts.account_company
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    vat_id_provided,
    verification
  )::stripe_accounts.account_company;
$$;
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_company_verification_document(
  back JSONB DEFAULT NULL,
  details TEXT DEFAULT NULL,
  details_code TEXT DEFAULT NULL,
  front JSONB DEFAULT NULL
)
RETURNS stripe_accounts.account_company_verification_document
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    back, details, details_code, front
  )::stripe_accounts.account_company_verification_document;
$$;
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_controller(
  ...
  stripe_dashboard stripe_accounts.account_controller_stripe_dashboard DEFAULT NULL
)
RETURNS stripe_accounts.account_controller
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
...
ALTER TYPE stripe_accounts.account_controller_fee
  ADD ATTRIBUTE payer TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_controller_fee(
  payer TEXT
)
RETURNS stripe_accounts.account_controller_fee
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(payer)::stripe_accounts.account_controller_fee;
$$;

ALTER TYPE stripe_accounts.account_controller_loss
  ADD ATTRIBUTE payments TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_controller_loss(
  payments TEXT
)
RETURNS stripe_accounts.account_controller_loss
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(payments)::stripe_accounts.account_controller_loss;
$$;
...
ALTER TYPE stripe_accounts.account_future_requirement
  ADD ATTRIBUTE alternatives stripe_accounts.account_requirements_alternative[],
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_future_requirement(
  alternatives stripe_accounts.account_requirements_alternative[] DEFAULT NULL,
...
RETURNS stripe_accounts.account_future_requirement
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
  ...
  )::stripe_accounts.account_future_requirement;
$$;

ALTER TYPE stripe_accounts.account_group
  ADD ATTRIBUTE payments_pricing TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_group(
  payments_pricing TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_group
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(payments_pricing)::stripe_accounts.account_group;
$$;
...
ALTER TYPE stripe_accounts.account_individual
  ...
  ADD ATTRIBUTE address_kana stripe_accounts.legal_entity_japan_address,
  ADD ATTRIBUTE address_kanji stripe_accounts.legal_entity_japan_address,
  ADD ATTRIBUTE dob stripe_accounts.account_individual_dob,
  ADD ATTRIBUTE email TEXT,
  ...
  ADD ATTRIBUTE future_requirements stripe_accounts.account_individual_future_requirement,
  ...
  ADD ATTRIBUTE relationship stripe_accounts.account_individual_relationship,
  ADD ATTRIBUTE requirements stripe_accounts.account_individual_requirement,
  ADD ATTRIBUTE ssn_last_4_provided BOOLEAN,
  ADD ATTRIBUTE us_cfpb_data stripe_accounts.account_individual_us_cfpb_data,
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual(
  ...
  address_kana stripe_accounts.legal_entity_japan_address DEFAULT NULL,
  address_kanji stripe_accounts.legal_entity_japan_address DEFAULT NULL,
  dob stripe_accounts.account_individual_dob DEFAULT NULL,
  email TEXT DEFAULT NULL,
  first_name TEXT DEFAULT NULL,
  first_name_kana TEXT DEFAULT NULL,
  first_name_kanji TEXT DEFAULT NULL,
  full_name_aliases TEXT[] DEFAULT NULL,
  future_requirements stripe_accounts.account_individual_future_requirement DEFAULT NULL,
  ...
  relationship stripe_accounts.account_individual_relationship DEFAULT NULL,
  requirements stripe_accounts.account_individual_requirement DEFAULT NULL,
  ssn_last_4_provided BOOLEAN DEFAULT NULL,
  us_cfpb_data stripe_accounts.account_individual_us_cfpb_data DEFAULT NULL,
  verification stripe_accounts.account_individual_verification DEFAULT NULL
)
RETURNS stripe_accounts.account_individual
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    us_cfpb_data,
    verification
  )::stripe_accounts.account_individual;
$$;

ALTER TYPE stripe_accounts.account_individual_additional_tos_acceptance
  ADD ATTRIBUTE account stripe_accounts.account_individual_additional_tos_acceptance_account;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_additional_tos_acceptance(
  account stripe_accounts.account_individual_additional_tos_acceptance_account DEFAULT NULL
)
RETURNS stripe_accounts.account_individual_additional_tos_acceptance
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    account
  )::stripe_accounts.account_individual_additional_tos_acceptance;
$$;
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_future_requirement(
  currently_due TEXT[],
...
RETURNS stripe_accounts.account_individual_future_requirement
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    pending_verification,
    alternatives
  )::stripe_accounts.account_individual_future_requirement;
$$;

ALTER TYPE stripe_accounts.account_individual_relationship
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_relationship(
...
RETURNS stripe_accounts.account_individual_relationship
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    representative,
    title
  )::stripe_accounts.account_individual_relationship;
$$;

ALTER TYPE stripe_accounts.account_individual_requirement
  ADD ATTRIBUTE currently_due TEXT[],
  ADD ATTRIBUTE errors stripe.account_requirements_error[],
  ADD ATTRIBUTE eventually_due TEXT[],
  ADD ATTRIBUTE past_due TEXT[],
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_requirement(
  currently_due TEXT[],
  errors stripe.account_requirements_error[],
  eventually_due TEXT[],
  past_due TEXT[],
...
RETURNS stripe_accounts.account_individual_requirement
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    pending_verification,
    alternatives
  )::stripe_accounts.account_individual_requirement;
$$;

ALTER TYPE stripe_accounts.account_individual_us_cfpb_data
  ADD ATTRIBUTE ethnicity_details stripe_accounts.account_individual_us_cfpb_data_ethnicity_detail,
  ADD ATTRIBUTE race_details stripe_accounts.account_individual_us_cfpb_data_race_detail,
  ADD ATTRIBUTE self_identified_gender TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_us_cfpb_data(
  ethnicity_details stripe_accounts.account_individual_us_cfpb_data_ethnicity_detail DEFAULT NULL,
  race_details stripe_accounts.account_individual_us_cfpb_data_race_detail DEFAULT NULL,
  self_identified_gender TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_individual_us_cfpb_data
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ethnicity_details, race_details, self_identified_gender
  )::stripe_accounts.account_individual_us_cfpb_data;
$$;

ALTER TYPE stripe_accounts.account_individual_us_cfpb_data_ethnicity_detail
  ADD ATTRIBUTE ethnicity TEXT[], ADD ATTRIBUTE ethnicity_other TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_us_cfpb_data_ethnicity_detail(
  ethnicity TEXT[] DEFAULT NULL, ethnicity_other TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_individual_us_cfpb_data_ethnicity_detail
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ethnicity, ethnicity_other
  )::stripe_accounts.account_individual_us_cfpb_data_ethnicity_detail;
$$;

ALTER TYPE stripe_accounts.account_individual_us_cfpb_data_race_detail
  ADD ATTRIBUTE race TEXT[], ADD ATTRIBUTE race_other TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_us_cfpb_data_race_detail(
  race TEXT[] DEFAULT NULL, race_other TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_individual_us_cfpb_data_race_detail
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    race, race_other
  )::stripe_accounts.account_individual_us_cfpb_data_race_detail;
$$;

ALTER TYPE stripe_accounts.account_individual_verification
...
ALTER TYPE stripe_accounts.account_individual_verification_additional_document
  ADD ATTRIBUTE back JSONB,
  ADD ATTRIBUTE details TEXT,
  ADD ATTRIBUTE details_code TEXT,
  ADD ATTRIBUTE front JSONB;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_verification_additional_document(
  back JSONB DEFAULT NULL,
  details TEXT DEFAULT NULL,
  details_code TEXT DEFAULT NULL,
  front JSONB DEFAULT NULL
)
RETURNS stripe_accounts.account_individual_verification_additional_document
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    back, details, details_code, front
  )::stripe_accounts.account_individual_verification_additional_document;
$$;

ALTER TYPE stripe_accounts.account_individual_verification_document
  ADD ATTRIBUTE back JSONB,
  ADD ATTRIBUTE details TEXT,
  ADD ATTRIBUTE details_code TEXT,
  ADD ATTRIBUTE front JSONB;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_individual_verification_document(
  back JSONB DEFAULT NULL,
  details TEXT DEFAULT NULL,
  details_code TEXT DEFAULT NULL,
  front JSONB DEFAULT NULL
)
RETURNS stripe_accounts.account_individual_verification_document
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    back, details, details_code, front
  )::stripe_accounts.account_individual_verification_document;
$$;

ALTER TYPE stripe_accounts.account_requirement
  ADD ATTRIBUTE alternatives stripe_accounts.account_requirements_alternative[],
  ADD ATTRIBUTE current_deadline BIGINT,
  ADD ATTRIBUTE currently_due TEXT[],
  ADD ATTRIBUTE disabled_reason TEXT,
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_requirement(
  alternatives stripe_accounts.account_requirements_alternative[] DEFAULT NULL,
  current_deadline BIGINT DEFAULT NULL,
  currently_due TEXT[] DEFAULT NULL,
  disabled_reason TEXT DEFAULT NULL,
...
RETURNS stripe_accounts.account_requirement
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    past_due,
    pending_verification
  )::stripe_accounts.account_requirement;
$$;
...
RETURNS stripe_accounts.account_tos_acceptance
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
...
ALTER TYPE stripe_accounts.account_invoices_settings
  ADD ATTRIBUTE default_account_tax_ids JSONB[],
  ADD ATTRIBUTE hosted_payment_method_save TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_invoices_settings(
  default_account_tax_ids JSONB[] DEFAULT NULL,
  hosted_payment_method_save TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_invoices_settings
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    default_account_tax_ids, hosted_payment_method_save
  )::stripe_accounts.account_invoices_settings;
$$;

ALTER TYPE stripe_accounts.account_requirements_alternative
  ADD ATTRIBUTE alternative_fields_due TEXT[],
  ADD ATTRIBUTE original_fields_due TEXT[];

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_requirements_alternative(
  alternative_fields_due TEXT[], original_fields_due TEXT[]
)
RETURNS stripe_accounts.account_requirements_alternative
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    alternative_fields_due, original_fields_due
  )::stripe_accounts.account_requirements_alternative;
$$;

ALTER TYPE stripe_accounts.account_settings
  ADD ATTRIBUTE branding stripe_accounts.account_settings_branding,
  ADD ATTRIBUTE card_payments stripe_accounts.account_settings_card_payment,
  ADD ATTRIBUTE dashboard stripe_accounts.account_settings_dashboard,
  ADD ATTRIBUTE payments stripe_accounts.account_settings_payment,
  ADD ATTRIBUTE bacs_debit_payments stripe_accounts.account_settings_bacs_debit_payment,
  ADD ATTRIBUTE card_issuing stripe_accounts.account_settings_card_issuing,
  ADD ATTRIBUTE invoices JSONB,
  ADD ATTRIBUTE payouts stripe_accounts.account_settings_payout,
  ADD ATTRIBUTE sepa_debit_payments stripe_accounts.account_settings_sepa_debit_payment,
  ADD ATTRIBUTE treasury stripe_accounts.account_settings_treasury;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings(
  branding stripe_accounts.account_settings_branding,
  card_payments stripe_accounts.account_settings_card_payment,
  dashboard stripe_accounts.account_settings_dashboard,
  payments stripe_accounts.account_settings_payment,
  bacs_debit_payments stripe_accounts.account_settings_bacs_debit_payment DEFAULT NULL,
  card_issuing stripe_accounts.account_settings_card_issuing DEFAULT NULL,
  invoices JSONB DEFAULT NULL,
  payouts stripe_accounts.account_settings_payout DEFAULT NULL,
  sepa_debit_payments stripe_accounts.account_settings_sepa_debit_payment DEFAULT NULL,
  treasury stripe_accounts.account_settings_treasury DEFAULT NULL
)
RETURNS stripe_accounts.account_settings
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    sepa_debit_payments,
    treasury
  )::stripe_accounts.account_settings;
$$;

ALTER TYPE stripe_accounts.account_settings_branding
  ADD ATTRIBUTE icon JSONB,
  ADD ATTRIBUTE logo JSONB,
  ADD ATTRIBUTE primary_color TEXT,
  ADD ATTRIBUTE secondary_color TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_branding(
  icon JSONB DEFAULT NULL,
  logo JSONB DEFAULT NULL,
  primary_color TEXT DEFAULT NULL,
  secondary_color TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_settings_branding
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    icon, logo, primary_color, secondary_color
  )::stripe_accounts.account_settings_branding;
$$;

ALTER TYPE stripe_accounts.account_settings_card_payment
  ADD ATTRIBUTE decline_on stripe_accounts.account_settings_card_payment_decline_on,
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_card_payment(
  decline_on stripe_accounts.account_settings_card_payment_decline_on DEFAULT NULL,
...
RETURNS stripe_accounts.account_settings_card_payment
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
  ...
  )::stripe_accounts.account_settings_card_payment;
$$;

ALTER TYPE stripe_accounts.account_settings_card_payment_decline_on
  ADD ATTRIBUTE avs_failure BOOLEAN, ADD ATTRIBUTE cvc_failure BOOLEAN;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_card_payment_decline_on(
  avs_failure BOOLEAN, cvc_failure BOOLEAN
)
RETURNS stripe_accounts.account_settings_card_payment_decline_on
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    avs_failure, cvc_failure
  )::stripe_accounts.account_settings_card_payment_decline_on;
$$;

ALTER TYPE stripe_accounts.account_settings_dashboard
  ADD ATTRIBUTE display_name TEXT, ADD ATTRIBUTE timezone TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_dashboard(
  display_name TEXT DEFAULT NULL, timezone TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_settings_dashboard
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    display_name, timezone
  )::stripe_accounts.account_settings_dashboard;
$$;

ALTER TYPE stripe_accounts.account_settings_payment
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_payment(
...
RETURNS stripe_accounts.account_settings_payment
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    statement_descriptor, statement_descriptor_kana, statement_descriptor_kanji
  )::stripe_accounts.account_settings_payment;
$$;

ALTER TYPE stripe_accounts.account_settings_bacs_debit_payment
  ADD ATTRIBUTE display_name TEXT, ADD ATTRIBUTE service_user_number TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_bacs_debit_payment(
  display_name TEXT DEFAULT NULL, service_user_number TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_settings_bacs_debit_payment
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    display_name, service_user_number
  )::stripe_accounts.account_settings_bacs_debit_payment;
$$;

ALTER TYPE stripe_accounts.account_settings_card_issuing
  ADD ATTRIBUTE tos_acceptance stripe_accounts.account_settings_card_issuing_tos_acceptance;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_card_issuing(
  tos_acceptance stripe_accounts.account_settings_card_issuing_tos_acceptance DEFAULT NULL
)
RETURNS stripe_accounts.account_settings_card_issuing
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(tos_acceptance)::stripe_accounts.account_settings_card_issuing;
$$;
...
ALTER TYPE stripe_accounts.account_settings_payout
  ADD ATTRIBUTE debit_negative_balances BOOLEAN,
  ADD ATTRIBUTE schedule stripe_accounts.account_settings_payout_schedule,
  ADD ATTRIBUTE statement_descriptor TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_payout(
  debit_negative_balances BOOLEAN,
  schedule stripe_accounts.account_settings_payout_schedule,
  statement_descriptor TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_settings_payout
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    debit_negative_balances, schedule, statement_descriptor
  )::stripe_accounts.account_settings_payout;
$$;

ALTER TYPE stripe_accounts.account_settings_payout_schedule
...
CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_payout_schedule(
  delay_days BIGINT,
  "interval" TEXT,
...
RETURNS stripe_accounts.account_settings_payout_schedule
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(
    ...
    weekly_anchor,
    weekly_payout_days
  )::stripe_accounts.account_settings_payout_schedule;
$$;

ALTER TYPE stripe_accounts.account_settings_sepa_debit_payment
  ADD ATTRIBUTE creditor_id TEXT;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_sepa_debit_payment(
  creditor_id TEXT DEFAULT NULL
)
RETURNS stripe_accounts.account_settings_sepa_debit_payment
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(creditor_id)::stripe_accounts.account_settings_sepa_debit_payment;
$$;

ALTER TYPE stripe_accounts.account_settings_treasury
  ADD ATTRIBUTE tos_acceptance stripe_accounts.account_settings_treasury_tos_acceptance;

CREATE OR REPLACE FUNCTION stripe_accounts.make_account_settings_treasury(
  tos_acceptance stripe_accounts.account_settings_treasury_tos_acceptance DEFAULT NULL
)
RETURNS stripe_accounts.account_settings_treasury
LANGUAGE SQL
IMMUTABLE
AS $$
  SELECT ROW(tos_acceptance)::stripe_accounts.account_settings_treasury;
$$;
...
ALTER TYPE stripe_accounts.legal_entity_japan_address
...
CREATE OR REPLACE FUNCTION stripe_accounts._retrieve(expand TEXT[] DEFAULT NULL)
RETURNS JSONB
LANGUAGE plpython3u
STABLE
AS $$
...
CREATE OR REPLACE FUNCTION stripe_accounts.retrieve(expand TEXT[] DEFAULT NULL)
RETURNS stripe_accounts.account
LANGUAGE plpgsql
STABLE
AS $$
  BEGIN
    ...
    RETURN jsonb_populate_record(
      NULL::stripe_accounts.account, stripe_accounts._retrieve(expand)
    );
  END;
$$;