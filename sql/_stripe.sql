...
CREATE TYPE stripe_coupons.create_params_applies_to AS ();
...
CREATE TYPE stripe_customers.create_params_cash_balance AS ();
CREATE TYPE stripe_customers.create_params_cash_balance_create_params_setting AS ();
CREATE TYPE stripe_customers.create_params_invoice_setting AS ();
CREATE TYPE stripe_customers.create_params_tax AS ();
CREATE TYPE stripe_customers.create_params_tax_id_data AS ();
...
CREATE TYPE stripe_disputes.update_params_evidence AS ();
...
CREATE TYPE stripe_invoices.create_params_automatic_tax AS ();
CREATE TYPE stripe_invoices.create_params_automatic_tax_create_params_liability AS ();
CREATE TYPE stripe_invoices.create_params_from_invoice AS ();
CREATE TYPE stripe_invoices.create_params_issuer AS ();
CREATE TYPE stripe_invoices.create_params_payment_setting AS ();
CREATE TYPE stripe_invoices.crate_prams_payment_setting_create_params_payment_method_option AS ();
CREATE TYPE stripe_invoices.create_params_rendering AS ();
CREATE TYPE stripe_invoices.create_params_rendering_create_params_pdf AS ();
CREATE TYPE stripe_invoices.create_params_shipping_cost AS ();
CREATE TYPE stripe_invoices.create_params_shipping_cost_create_params_shipping_rate_data AS ();
CREATE TYPE stripe_invoices.c_p_shppng_cst_crte_prms_shppng_rte_dta_crte_prms_dlvry_estmte AS ();
CREATE TYPE stripe_invoices.c_p_s_c_c_p_s_rte_dta_crte_prms_dlvry_estmte_crte_prms_mxmm AS ();
CREATE TYPE stripe_invoices.c_p_s_c_c_p_s_rte_dta_crte_prms_dlvry_estmte_crte_prms_mnmm AS ();
CREATE TYPE stripe_invoices.c_prms_shppng_cst_crte_prms_shppng_rte_dta_crte_prms_fxd_amnt AS ();
CREATE TYPE stripe_invoices.create_params_shipping_detail AS ();
CREATE TYPE stripe_invoices.create_params_shipping_detail_create_params_address AS ();
CREATE TYPE stripe_invoices.create_params_transfer_data AS ();
...
CREATE TYPE stripe_invoiceitems.create_params_period AS ();
CREATE TYPE stripe_invoiceitems.create_params_price_data AS ();
CREATE TYPE stripe_invoiceitems.create_params_pricing AS ();
...
CREATE TYPE stripe_payment_links.create_params_line_item AS ();
CREATE TYPE stripe_payment_links.create_params_line_item_create_params_adjustable_quantity AS ();
CREATE TYPE stripe_payment_links.create_params_line_item_create_params_price_data AS ();
CREATE TYPE stripe_payment_links.crate_prams_lne_itm_crate_prams_prce_dta_crate_prams_prduct_dta AS ();
CREATE TYPE stripe_payment_links.crate_prams_lne_itm_crate_prams_prce_dta_crate_params_recurring AS ();
CREATE TYPE stripe_payment_links.create_params_after_completion AS ();
CREATE TYPE stripe_payment_links.crate_params_after_completion_create_params_hosted_confirmation AS ();
CREATE TYPE stripe_payment_links.create_params_after_completion_create_params_redirect AS ();
CREATE TYPE stripe_payment_links.create_params_automatic_tax AS ();
CREATE TYPE stripe_payment_links.create_params_automatic_tax_create_params_liability AS ();
CREATE TYPE stripe_payment_links.create_params_consent_collection AS ();
CREATE TYPE stripe_payment_links.crte_prms_cnsnt_cllction_crate_prams_pyment_mthod_ruse_agrement AS ();
CREATE TYPE stripe_payment_links.create_params_custom_field AS ();
CREATE TYPE stripe_payment_links.create_params_custom_field_create_params_label AS ();
CREATE TYPE stripe_payment_links.create_params_custom_field_create_params_dropdown AS ();
CREATE TYPE stripe_payment_links.crate_prams_cstom_feld_crate_prams_drpdown_create_params_option AS ();
CREATE TYPE stripe_payment_links.create_params_custom_field_create_params_numeric AS ();
CREATE TYPE stripe_payment_links.create_params_custom_field_create_params_text AS ();
CREATE TYPE stripe_payment_links.create_params_custom_text AS ();
CREATE TYPE stripe_payment_links.create_params_invoice_creation AS ();
CREATE TYPE stripe_payment_links.create_params_invoice_creation_create_params_invoice_data AS ();
CREATE TYPE stripe_payment_links.crte_prms_invce_crtion_crate_prams_invice_dta_crate_prams_isser AS ();
CREATE TYPE stripe_payment_links.create_params_name_collection AS ();
CREATE TYPE stripe_payment_links.create_params_name_collection_create_params_business AS ();
CREATE TYPE stripe_payment_links.create_params_name_collection_create_params_individual AS ();
CREATE TYPE stripe_payment_links.create_params_optional_item AS ();
CREATE TYPE stripe_payment_links.create_params_optional_item_create_params_adjustable_quantity AS ();
CREATE TYPE stripe_payment_links.create_params_payment_intent_data AS ();
CREATE TYPE stripe_payment_links.create_params_phone_number_collection AS ();
CREATE TYPE stripe_payment_links.create_params_restriction AS ();
CREATE TYPE stripe_payment_links.create_params_restriction_create_params_completed_session AS ();
CREATE TYPE stripe_payment_links.create_params_shipping_address_collection AS ();
CREATE TYPE stripe_payment_links.create_params_shipping_option AS ();
CREATE TYPE stripe_payment_links.create_params_subscription_data AS ();
CREATE TYPE stripe_payment_links.create_params_subscription_data_create_params_invoice_setting AS ();
CREATE TYPE stripe_payment_links.crte_prms_sbscrption_dta_crte_prms_invce_sttng_crte_prams_isser AS ();
CREATE TYPE stripe_payment_links.create_params_subscription_data_create_params_trial_setting AS ();
CREATE TYPE stripe_payment_links.crte_prms_sbscrpton_dta_crte_prms_trl_sttng_crte_prms_end_bhvor AS ();
CREATE TYPE stripe_payment_links.create_params_tax_id_collection AS ();
CREATE TYPE stripe_payment_links.create_params_transfer_data AS ();
...
CREATE TYPE stripe_prices.create_params_custom_unit_amount AS ();
CREATE TYPE stripe_prices.create_params_product_data AS ();
CREATE TYPE stripe_prices.create_params_recurring AS ();
CREATE TYPE stripe_prices.create_params_tier AS ();
CREATE TYPE stripe_prices.create_params_transform_quantity AS ();
CREATE TYPE stripe_prices.list_params_recurring AS ();
...
CREATE TYPE stripe_products.create_params_default_price_data AS ();
CREATE TYPE stripe_products.crate_prams_default_price_data_create_params_custom_unit_amount AS ();
CREATE TYPE stripe_products.create_params_default_price_data_create_params_recurring AS ();
CREATE TYPE stripe_products.create_params_marketing_feature AS ();
CREATE TYPE stripe_products.create_params_package_dimension AS ();
...
CREATE TYPE stripe_subscriptions.update_params_add_invoice_item AS ();
CREATE TYPE stripe_subscriptions.update_params_add_invoice_item_update_params_discount AS ();
CREATE TYPE stripe_subscriptions.update_params_add_invoice_item_update_params_period AS ();
CREATE TYPE stripe_subscriptions.updte_prams_add_invice_itm_updte_prams_period_update_params_end AS ();
CREATE TYPE stripe_subscriptions.updte_prams_add_invice_itm_updte_prams_priod_updte_params_start AS ();
CREATE TYPE stripe_subscriptions.update_params_add_invoice_item_update_params_price_data AS ();
CREATE TYPE stripe_subscriptions.update_params_automatic_tax AS ();
CREATE TYPE stripe_subscriptions.update_params_automatic_tax_update_params_liability AS ();
CREATE TYPE stripe_subscriptions.update_params_cancellation_detail AS ();
CREATE TYPE stripe_subscriptions.update_params_invoice_setting AS ();
CREATE TYPE stripe_subscriptions.update_params_invoice_setting_update_params_issuer AS ();
CREATE TYPE stripe_subscriptions.update_params_item AS ();
CREATE TYPE stripe_subscriptions.update_params_item_update_params_price_data AS ();
CREATE TYPE stripe_subscriptions.updte_prams_itm_updte_params_price_data_update_params_recurring AS ();
CREATE TYPE stripe_subscriptions.update_params_payment_setting AS ();
CREATE TYPE stripe_subscriptions.updte_prams_payment_setting_update_params_payment_method_option AS ();
CREATE TYPE stripe_subscriptions.update_params_trial_setting AS ();
CREATE TYPE stripe_subscriptions.update_params_trial_setting_update_params_end_behavior AS ();
CREATE TYPE stripe_subscriptions.list_params_automatic_tax AS ();
CREATE TYPE stripe_subscriptions.cancel_params_cancellation_detail AS ();