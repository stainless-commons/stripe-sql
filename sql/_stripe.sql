...
CREATE TYPE stripe_disputes.c_b_resource_cash_balance_transaction_adjusted_for_overdraft AS ();
CREATE TYPE stripe_disputes.c_balance_resource_cash_balance_transaction_applied_to_payment AS ();
CREATE TYPE stripe_disputes.c_b_resource_cash_balance_transaction_refunded_from_payment AS ();
CREATE TYPE stripe_disputes.c_b_resource_cash_balance_transaction_transferred_to_balance AS ();
CREATE TYPE stripe_disputes.c_b_resource_cash_balance_transaction_unapplied_from_payment AS ();
...
CREATE TYPE stripe_disputes.c_c_balance_transaction_funded_bank_transfer_eu_bank_transfer AS ();
CREATE TYPE stripe_disputes.c_c_balance_transaction_funded_bank_transfer_gb_bank_transfer AS ();
CREATE TYPE stripe_disputes.c_c_balance_transaction_funded_bank_transfer_jp_bank_transfer AS ();
CREATE TYPE stripe_disputes.c_c_balance_transaction_funded_bank_transfer_us_bank_transfer AS ();
...
CREATE TYPE stripe_disputes.d_e_e_e_visa_compelling_evidence_3_prior_undisputed_transaction AS ();
CREATE TYPE stripe_disputes.d_e_e_e_v_c_e_3_prior_undisputed_transaction_shipping_address AS ();
CREATE TYPE stripe_disputes.d_e_e_evidence_visa_compelling_evidence_3_disputed_transaction AS ();
CREATE TYPE stripe_disputes.d_e_e_e_v_c_evidence_3_disputed_transaction_shipping_address AS ();
...
CREATE TYPE stripe_disputes.d_e_detail_enhanced_eligibility_visa_compelling_evidence_3 AS ();
...
CREATE TYPE stripe_disputes.i_authorization_verification_data_authentication_exemption AS ();
...
CREATE TYPE stripe_disputes.i_transaction_purchase_detail_fleet_cardholder_prompt_data AS ();
CREATE TYPE stripe_disputes.issuing_transaction_purchase_detail_fleet_reported_breakdown AS ();
CREATE TYPE stripe_disputes.i_transaction_purchase_detail_fleet_reported_breakdown_fuel AS ();
CREATE TYPE stripe_disputes.i_transaction_purchase_detail_fleet_reported_breakdown_non_fuel AS ();
CREATE TYPE stripe_disputes.i_transaction_purchase_detail_fleet_reported_breakdown_tax AS ();
...
CREATE TYPE stripe_invoices.b_bill_resource_invoicing_parents_invoice_parent_quote_detail AS ();
CREATE TYPE stripe_invoices.b_bill_resource_invoicing_parents_invoice_subscription_parent AS ();
...
CREATE TYPE stripe_invoices.b_c_grants_resource_balance_credits_application_invoice_voided AS ();
...
CREATE TYPE stripe_invoices.i_p_setting_payment_method_option_acss_debit_mandate_option AS ();
...
CREATE TYPE stripe_invoices.i_p_s_payment_method_option_customer_balance_bank_transfer AS ();
CREATE TYPE stripe_invoices.i_p_s_p_m_o_customer_balance_bank_transfer_eu_bank_transfer AS ();
...
CREATE TYPE stripe_invoices.i_payment_setting_payment_method_option_payto_mandate_option AS ();
...
CREATE TYPE stripe_invoices.i_p_s_p_method_option_us_bank_account_financial_connection AS ();
CREATE TYPE stripe_invoices.i_p_s_p_m_option_us_bank_account_financial_connection_filter AS ();
...
CREATE TYPE stripe_invoices.l_i_parent_invoice_item_detail_proration_detail_credited_item AS ();
...
CREATE TYPE stripe_invoices.l_i_p_subscription_item_detail_proration_detail_credited_item AS ();
...
CREATE TYPE stripe_invoices.p_primitives_payment_records_resource_payment_method_details AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_ach_credit_transfer AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_ach_debit AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_acss_debit AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_affirm AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_afterpay_clearpay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_alipay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_alma AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_alma_installment AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_amazon_pay AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_amazon_pay_funding AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_au_becs_debit AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_bacs_debit AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_billie AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_billing_detail AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_billing_detail_address AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_blik AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_boleto AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_card AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_card_check AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_card_installment AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_card_installment_plan AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_card_network_token AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_card_three_d_secure AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_card_wallet AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_card_wallet_apple_pay AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_card_wallet_google_pay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_cashapp AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_crypto AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_custom AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_customer_balance AS ();
CREATE TYPE stripe_invoices.p_primitives_payment_records_resource_payment_method_details_ep AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_fpx AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_giropay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_grabpay AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_interac_present AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_interac_present_receipt AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_kakao_pay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_klarna AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_klarna_payer_detail AS ();
CREATE TYPE stripe_invoices.p_p_p_r_r_payment_method_details_klarna_payer_detail_address AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_konbini AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_konbini_store AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_kr_card AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_link AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_mb_way AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_mobilepay AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_mobilepay_card AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_multibanco AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_naver_pay AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_nz_bank_account AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_oxxo AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_p24 AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_pay_by_bank AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_payco AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_paynow AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_paypal AS ();
CREATE TYPE stripe_invoices.p_p_p_r_r_payment_method_details_paypal_seller_protection AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_payto AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_pix AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_promptpay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_revolut_pay AS ();
CREATE TYPE stripe_invoices.p_p_p_r_resource_payment_method_details_revolut_pay_funding AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_samsung_pay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_satispay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_sepa_debit AS ();
CREATE TYPE stripe_invoices.p_p_p_records_resource_payment_method_details_stripe_account AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_swish AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_twint AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_wechat AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_wechat_pay AS ();
CREATE TYPE stripe_invoices.p_p_payment_records_resource_payment_method_details_zip AS ();
...
CREATE TYPE stripe_payment_links.p_link_create_response_after_completion_hosted_confirmation AS ();
...
CREATE TYPE stripe_payment_links.p_l_c_r_consent_collection_payment_method_reuse_agreement AS ();
...
CREATE TYPE stripe_payment_links.p_l_c_response_invoice_creation_invoice_data_rendering_option AS ();
...
CREATE TYPE stripe_payment_links.p_l_c_response_subscription_data_trial_setting_end_behavior AS ();
...
CREATE TYPE stripe_payment_intents.p_intent_amount_detail_line_item_data_payment_method_option AS ();
CREATE TYPE stripe_payment_intents.p_i_amount_detail_line_item_data_payment_method_option_card AS ();
CREATE TYPE stripe_payment_intents.p_i_a_detail_line_item_data_payment_method_option_card_present AS ();
CREATE TYPE stripe_payment_intents.p_i_amount_detail_line_item_data_payment_method_option_klarna AS ();
CREATE TYPE stripe_payment_intents.p_i_amount_detail_line_item_data_payment_method_option_paypal AS ();
...
CREATE TYPE stripe_payment_intents.p_intent_next_action_cashapp_handle_redirect_or_display_qr_code AS ();
CREATE TYPE stripe_payment_intents.p_i_n_action_cashapp_handle_redirect_or_display_qr_code_qr_code AS ();
CREATE TYPE stripe_payment_intents.payment_intent_next_action_display_bank_transfer_instruction AS ();
CREATE TYPE stripe_payment_intents.p_i_n_a_display_bank_transfer_instruction_financial_address AS ();
CREATE TYPE stripe_payment_intents.p_i_n_a_display_bank_transfer_instruction_financial_address_aba AS ();
CREATE TYPE stripe_payment_intents.p_i_n_a_d_bank_transfer_instruction_financial_address_iban AS ();
CREATE TYPE stripe_payment_intents.p_i_n_a_d_bank_transfer_instruction_financial_address_sort_code AS ();
CREATE TYPE stripe_payment_intents.p_i_n_a_d_bank_transfer_instruction_financial_address_spei AS ();
CREATE TYPE stripe_payment_intents.p_i_n_a_d_bank_transfer_instruction_financial_address_swift AS ();
CREATE TYPE stripe_payment_intents.p_i_n_a_d_bank_transfer_instruction_financial_address_zengin AS ();
...
CREATE TYPE stripe_payment_intents.p_intent_next_action_konbini_display_detail_store_familymart AS ();
CREATE TYPE stripe_payment_intents.payment_intent_next_action_konbini_display_detail_store_lawson AS ();
CREATE TYPE stripe_payment_intents.p_intent_next_action_konbini_display_detail_store_ministop AS ();
CREATE TYPE stripe_payment_intents.p_intent_next_action_konbini_display_detail_store_seicomart AS ();
...
CREATE TYPE stripe_payment_intents.p_intent_next_action_swish_handle_redirect_or_display_qr_code AS ();
CREATE TYPE stripe_payment_intents.p_i_n_action_swish_handle_redirect_or_display_qr_code_qr_code AS ();
...
CREATE TYPE stripe_payment_intents.p_intent_payment_method_option_customer_balance_bank_transfer AS ();
CREATE TYPE stripe_payment_intents.p_i_p_m_option_customer_balance_bank_transfer_eu_bank_transfer AS ();
...
CREATE TYPE stripe_payment_intents.p_i_payment_method_option_us_bank_account_financial_connection AS ();
CREATE TYPE stripe_payment_intents.p_i_p_method_option_us_bank_account_financial_connection_filter AS ();
CREATE TYPE stripe_payment_intents.p_intent_payment_method_option_us_bank_account_mandate_option AS ();
...
CREATE TYPE stripe_subscriptions.s_intent_next_action_cashapp_handle_redirect_or_display_qr_code AS ();
CREATE TYPE stripe_subscriptions.s_i_n_action_cashapp_handle_redirect_or_display_qr_code_qr_code AS ();
...
CREATE TYPE stripe_subscriptions.s_i_payment_method_option_us_bank_account_financial_connection AS ();
CREATE TYPE stripe_subscriptions.s_i_p_method_option_us_bank_account_financial_connection_filter AS ();
CREATE TYPE stripe_subscriptions.s_intent_payment_method_option_us_bank_account_mandate_option AS ();
...
CREATE TYPE stripe_subscriptions.s_p_setting_payment_method_option_acss_debit_mandate_option AS ();
...
CREATE TYPE stripe_subscriptions.s_payment_setting_payment_method_option_card_mandate_option AS ();
CREATE TYPE stripe_subscriptions.s_payment_setting_payment_method_option_customer_balance AS ();
CREATE TYPE stripe_subscriptions.s_p_s_payment_method_option_customer_balance_bank_transfer AS ();
CREATE TYPE stripe_subscriptions.s_p_s_p_m_o_customer_balance_bank_transfer_eu_bank_transfer AS ();
...
CREATE TYPE stripe_subscriptions.s_payment_setting_payment_method_option_payto_mandate_option AS ();
CREATE TYPE stripe_subscriptions.subscription_payment_setting_payment_method_option_sepa_debit AS ();
CREATE TYPE stripe_subscriptions.s_payment_setting_payment_method_option_us_bank_account AS ();
CREATE TYPE stripe_subscriptions.s_p_s_p_method_option_us_bank_account_financial_connection AS ();
CREATE TYPE stripe_subscriptions.s_p_s_p_m_option_us_bank_account_financial_connection_filter AS ();
