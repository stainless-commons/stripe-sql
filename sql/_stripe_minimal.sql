...
CREATE TYPE stripe_minimal_coupon.coupon_list_response AS ();
...
CREATE TYPE stripe_minimal_customer.customer_list_response AS ();
...
CREATE TYPE stripe_minimal_dispute.dispute_list_response AS ();
...
CREATE TYPE stripe_minimal_invoice.invoice_list_response AS ();
...
CREATE TYPE stripe_minimal_payment_intent.payment_intent_list_response AS ();
...
CREATE TYPE stripe_minimal_price.price_list_response AS ();
...
CREATE TYPE stripe_minimal_product.product_list_response AS ();
...
CREATE TYPE stripe_minimal_subscription.subscription_list_response AS ();
